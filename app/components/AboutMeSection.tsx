...
export default function AboutMeSection() {
  return (
    <section
      id="about"
      className="snap-section bg-[#080808] text-[#CECECE] antialiased selection:bg-[#E3C896] selection:text-black min-h-screen lg:h-screen flex flex-col justify-center py-8 sm:py-10 lg:py-8 px-6 sm:px-10 lg:px-12 relative overflow-hidden"
    >
      ...
      <div className="relative z-10 w-full max-w-[1340px] mx-auto flex flex-col justify-between my-auto">
        {/* Section Header */}
        <header className="w-full flex flex-col items-center justify-center mb-6 lg:mb-8">
          <div className="flex items-center gap-3 text-xs tracking-[0.28em] text-[#E3C896] font-mono uppercase mb-1.5">
            <span className="text-[#E3C896] font-bold">02</span>
            <span className="text-[#E3C896]/50">//</span>
            <span className="text-white/80 tracking-[0.25em]">KODLARIN ARDINDAKİ İSİM</span>
          </div>

          <h2 className="text-2xl md:text-4xl lg:text-[42px] font-serif font-medium tracking-[0.16em] text-[#E3C896] uppercase text-center drop-shadow-[0_0_20px_rgba(227,200,150,0.35)]">
            HAKKIMDA
          </h2>

          <div className="w-full max-w-4xl mt-3 sm:mt-4 flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end">
            <motion.div
              ...
              className="group relative w-full max-w-[340px] xl:max-w-[380px] aspect-[4/5] rounded-sm overflow-hidden bg-gradient-to-b from-[#0d0d0e] to-black border border-white/10 shadow-glow-gold hover:border-[#E3C896]/50 transition-all duration-500 cursor-crosshair"
            >
                ...
                <div className="flex items-end justify-between border-b border-[#E3C896]/30 pb-2 mb-2">
                  <div>
                    ...
                    <h3 className="text-xl md:text-2xl font-tech font-bold text-white tracking-wider flex items-center gap-2">
                      BURAK İTİK
                      <span className="text-[10px] px-1.5 py-0.5 rounded bg-[#E3C896]/20 text-[#E3C896] font-mono border border-[#E3C896]/40">
                        LVL.99
                      </span>
                    </h3>
                  </div>
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-6 lg:pl-4">
            <div className="flex items-center gap-3">
              <div className="w-7 h-[1px] bg-[#E3C896]/60"></div>
              <span className="font-mono text-xs tracking-[0.28em] text-[#E3C896] uppercase">
                BEN KİMİM ?
              </span>
            </div>

            <h3 className="text-2xl sm:text-3xl lg:text-[34px] font-sans font-bold text-white tracking-tight uppercase leading-[1.18] max-w-2xl">
              TASARIMIN KODLA VE{" "}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-[13px] leading-relaxed text-zinc-300 font-sans pt-1">
            ...
            <div className="grid grid-cols-3 gap-y-4 gap-x-4 pt-1 font-mono uppercase text-xs">
              <div className="space-y-3">
                <div>
                  <span className="block text-[9px] tracking-[0.2em] text-[#E3C896]/70">
                    LOKASYON
                  </span>
                  <p className="text-white text-[12px] font-semibold tracking-wider mt-0.5">
                    TÜRKİYE / UZAKTAN
                  </p>
                </div>
                <div>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-[#E3C896] text-[12px] font-bold tracking-wider mt-0.5">
                    4+ TAMAMLANAN
                  </p>
                </div>
              </div>
            ...
            {/* Availability Status */}
            <div className="pt-4 flex items-center justify-between border-t border-white/5 text-[11px] font-mono">
        ...
        <footer className="mt-12 text-center text-[10px] font-mono tracking-widest text-zinc-600 uppercase border-t border-white/5 pt-4">
